...
public class VehicleUtil {
    ...
    public static void processVehicle(String type, Calendar checkIn, Calendar checkOut, Vehicle vehicle) {
        switch (type) {
            case "OFICIAL":
            ...
            case "NORESIDENT":
                ...
                double amountPerMinute = Double.valueOf(ConstantEnum.CHECKOUTAMOUNT.getValue());
